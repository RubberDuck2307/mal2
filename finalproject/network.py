...
class Net(tf.keras.Model):
    def __init__(self):
        ...
        self.out.add(layers.Conv2D(128, kernel_size=2, padding="valid", activation="gelu"))
        self.out.add(layers.Conv2D(64, kernel_size=2, padding="valid", activation="gelu"))
        self.out.add(layers.Conv2D(1 * 5, kernel_size=6, padding="valid", activation="sigmoid"))
